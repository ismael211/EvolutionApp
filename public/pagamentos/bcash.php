...
if($total_fatura->num_rows > 0) {
  ...
  // Verifica se a forma de pagamento da fatura é Bcash
...
Por favor aguarde, voc&ecirc; está sendo
 redirecionado para o site do bcash.com.br<br />Se você tem um anti-popup instalado, desabilite ele e atualize 
 a página.<br /><br />
