...
#instr_header {
	background: url('boletos/imagens/logo_empresa.gif') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
<div id="instr_content">
  <p>O pagamento deste boleto tamb&eacute;m poder&aacute; ser efetuado 
			...
			<li>
				Corte na linha indicada. Não rasure, risque, fure ou dobre a região onde se encontra o código de barras.</li>
			<li>Caso tenha problemas ao imprimir, copie a seq&uuml;encia num&eacute;rica abaixo e pague no caixa eletr&ocirc;nico ou pela internet:</li>
			</ol>
	        <span class="ld2">
<strong>&nbsp;&nbsp;&nbsp;&nbsp;Linha digitável: &nbsp;<?=$dadosboleto["linha_digitavel"]?><br>
&nbsp;&nbsp;&nbsp;&nbsp;Valor: &nbsp;R$ <?=$dadosboleto["valor_boleto"]?><br></strong>
</span>
</div>	<!-- id="instr_content" -->
	...
	<div id="boleto">
		...
		<tbody>
		<tr>
			<td><img src="boletos/imagens/logobb.jpg" width="150" height="40" border=0></td>
			<td><div class="field_cod_banco"><?=$dadosboleto["codigo_banco_com_dv"]?></div></td>
		...
		<tbody>
		<tr class="titulos">
			<td class="demonstrativo">Demonstrativo</td>
		</tr>
		<tr class="campos">
			<td class="sacado">
			<p><? echo $dadosboleto["demonstrativo1"]; ?></p>		
			<p><? echo $dadosboleto["demonstrativo2"]; ?></p>
			<p><? echo $dadosboleto["descricao"]; ?></p>
			<p><br /><?=$dadosboleto["taxa_pagamento"]?></p>
			</td>
		</tr>
		</tbody>
		</table>
