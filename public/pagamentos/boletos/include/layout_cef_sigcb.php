...
<BR><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
  <span class="campo"><IMG 
      src="boletos/imagens/logocaixa.jpg" width="150" height="40" 
      border=0></span></td>
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=268 height=12>
  <span class="campo"><?php echo $dadosboleto["cedente"]; ?></span></td>
<td class=cp valign=top width=7 height=12><img height=12 src=boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=156 height=12>
  <span class="campo">
