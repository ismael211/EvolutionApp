...
//Guarda inicial
?><img src=boletos/imagens/p.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
src=boletos/imagens/b.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
src=boletos/imagens/p.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
src=boletos/imagens/b.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
<?
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=boletos/imagens/p.gif width=<?=$f1?> height=<?=$altura?> border=0><img 
<?
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=boletos/imagens/b.gif width=<?=$f2?> height=<?=$altura?> border=0><img 
<?
  }
}
...
// Draw guarda final
?>
src=boletos/imagens/p.gif width=<?=$largo?> height=<?=$altura?> border=0><img 
src=boletos/imagens/b.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
src=boletos/imagens/p.gif width=<?=1?> height=<?=$altura?> border=0> 
  <?
} //Fim da função
